							...
							<div class="container-fluid">
								<div class="d-flex">
									...
									<div class="app-sidebar__toggle" data-toggle="sidebar">
										<a class="open-toggle" href="{{Route('Dashboard')}}">
									...
									<div class="d-flex order-lg-2 ml-auto">
										<a href="{{Route('Dashboard')}}" data-toggle="search" class="nav-link nav-link-lg d-md-none navsearch">
											<svg class="header-icon search-icon" x="1008" y="1248" viewBox="0 0 24 24"  height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false">
												<path d="M0 0h24v24H0V0z" fill="none"/><path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/>
											</svg>
										</a>
										<div class="dropdown   header-fullscreen">
											<a class="nav-link icon full-screen-link p-0">
												...
												{{-- <i class="fa fa-moon-o" data-toggle="tooltip" title="" data-original-title="fa fa-moon-o"></i> --}}
										
												{{-- <i class="fa fa-lightbulb-o" data-toggle="tooltip" title="" data-original-title="fa fa-lightbulb-o"></i>
												--}}
												...
												<ul class="icons-list">
													...
													<ul class="icons-list">
														@if(Auth::check() && Auth::user()->theme == 1)
															<li class="themeclick icons-list-item" data-theme="0">
																<i class="fa fa-moon-o" data-toggle="tooltip" title="Switch to Dark Mode"></i>
															</li>
														@else
															<li class="themeclick icons-list-item" data-theme="1">
																<i class="fa fa-lightbulb-o" data-toggle="tooltip" title="Switch to Light  Mode"></i>
															</li>
														@endif
													</ul>
										...
										<div class="dropdown header-message" style="display: none;">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
												...
												<div class=" text-center p-2 border-top">
													<a href="{{Route('Dashboard')}}" class="">See All Messages</a>
												</div>
											</div>
										</div>
										<div class="dropdown header-notify" style="display: none;">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
												...
												<div class="notify-menu">
													<a href="{{Route('Dashboard')}}" class="dropdown-item border-bottom d-flex pl-4">
												...
												<div class=" text-center p-2 border-top">
													<a href="{{Route('Dashboard')}}" class="">View All Notifications</a>
												</div>
											</div>
										</div>
										<div class="dropdown profile-dropdown">
											<a href="{{Route('Dashboard')}}" class="nav-link pr-0 leading-none" data-toggle="dropdown">
												<span>
													<img src="{{ asset(Auth::check() && Auth::user()->image && file_exists(public_path('uploads/profile_img/' . Auth::user()->image)) ? 'uploads/profile_img/' . Auth::user()->image : 'assets/images/users/2.jpg') }}" alt="img" class="avatar avatar-md brround">
												</span>
											</a>
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												<div class="text-center">
													<a href="{{Route('Dashboard')}}" class="dropdown-item text-center user pb-0 font-weight-bold">
												...
												{{-- <a class="dropdown-item d-flex" href="{{Route('Dashboard')}}">
													<svg class="header-icon mr-3" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM7.07 18.28c.43-.9 3.05-1.78 4.93-1.78s4.51.88 4.93 1.78C15.57 19.36 13.86 20 12 20s-3.57-.64-4.93-1.72zm11.29-1.45c-1.43-1.74-4.9-2.33-6.36-2.33s-4.93.59-6.36 2.33C4.62 15.49 4 13.82 4 12c0-4.41 3.59-8 8-8s8 3.59 8 8c0 1.82-.62 3.49-1.64 4.83zM12 6c-1.94 0-3.5 1.56-3.5 3.5S10.06 13 12 13s3.5-1.56 3.5-3.5S13.94 6 12 6zm0 5c-.83 0-1.5-.67-1.5-1.5S11.17 8 12 8s1.5.67 1.5 1.5S12.83 11 12 11z"/></svg>
