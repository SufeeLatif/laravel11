...
@section('css')
		...
		<link href="{Usersasset('assets/plugins/select2/select2.min.css')}}" rel="stylesheet" />
@endsection
@section('page-header')
						<!--Page header-->
						...
						<div class="row">
							<div class="col-xl-3 col-lg-4">
								<div class="card box-widget widget-user">
									<div class="widget-user-image mx-auto mt-5"><img alt="User Avatar" class="rounded-circle" src="{Usersasset('assets/images/users/2.jpg')}}"></div>
									...
									<div class="card-body">
										<div class="text-center mb-5">
											<div class="widget-user-image">
												<img alt="User Avatar" class="rounded-circle  mr-3" src="{Usersasset('assets/images/users/2.jpg')}}">
											</div>
										</div>
...
@section('js')
		<!-- INTERNAL Select2 js -->
		<script src="{Usersasset('assets/plugins/select2/select2.full.min.js')}}"></script>
		<script src="{Usersasset('assets/js/select2.js')}}"></script>
@endsection